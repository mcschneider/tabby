...
// If @font-face and pseudo selectors are supported, add '.js-font-face' class to <html> element
if (isFontFaceSupported && selectorSupported(':before')) {
	document.documentElement.className += (document.documentElement.className ? ' ' : '') + 'js-font-face';
}